...
export default function RideDashboard() {
    const { isLoadingRideDashboard, rideDashboardData, getRideDashboard } = UseGetRideDashboard();
    ...
    if (isLoadingRideDashboard || !rideDashboardData) {
        return (
        ...
        <Card className="w-full bg-white p-4">
            ...
            {!rideDashboardData?.ride_stats ? (
                ...
                <ChartContainer className="max-h-60 min-h-40 w-full" config={chartConfig}>
                    <BarChart data={rideDashboardData?.ride_stats}>
