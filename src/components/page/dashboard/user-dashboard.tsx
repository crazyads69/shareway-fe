...
export default function UserDashboard() {
    ...
    if (isLoadingUserDashboard || !userDashboardData) {
        return (
        ...
        <Card className="w-full bg-white p-4">
            <CardHeader className="flex items-center justify-between">
                <div className="flex w-full flex-row items-center justify-between">
                    <h2 className="select-none text-xl font-bold">Số lượng người dùng</h2>
            ...
            {!userDashboardData?.user_stats ? (
                ...
                <ChartContainer className="max-h-60 min-h-40 w-full" config={chartConfig}>
                    <BarChart data={userDashboardData?.user_stats}>
